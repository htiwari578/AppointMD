...
const Header = () => {
  return (
    ...
    px-6 md:px-10 lg:px-20">
        ...
        md:py-[10vw] md:mb-[-30px]">
            <p className="text-3xl md:text-4x lg:text-5xl text-white font-semibold leading-tight
            ...
            <Link to='' className="flex items-center gap-2 bg-white px-8 py-3 rounded-full text-gray-600 text-sm m-auto
