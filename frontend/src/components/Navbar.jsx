        ...
        <div className="flex items-center gap-4">
            {
                ...
                ? <div className="flex items-center gap-2 cursor-pointer group relative">
                    ...
                    z-20 hidden group-hover:block">
                        <div className="min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4"> 
                            ...
                            className="hover:text-blue-600 cursor-pointer">My Profile</p>
                            <p onClick = {()=> navigate('/my-appointments')}
                            className="hover:text-blue-600 cursor-pointer">My Appointments</p>
                            <p onClick={logout}
                            className="hover:text-red-600 cursor-pointer">Logout</p>
                        </div>
                     </div>
                ...
                font-medium hidden md:block">Create Account </button>
            }
