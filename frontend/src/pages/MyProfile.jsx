...
const MyProfile = () => {
  const [userData , setUserData] = useState({
    ...
    email:"Himanshtext@gmail.com",
    phone:"99999299922",
    address:{
      line1:"CGS Colony",
      line2:"Anotp Hill Mumbai"
    },
    gender:"Male",
    dob:"2000-01-20"
  });
  ...
  return (
    <div className="max-w-lg flex flex-col gap-2 text-sm">
      ...
      {
        isEdit ? <input className="max-w-28 bg-gray-100"
        type="date" onChange={(e)=> setUserData(prev => ({...prev, dob: e.target.value}))} 
        value={userData.dob} />
